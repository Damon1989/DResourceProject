...
﻿using Abp.Owin;
using DResourceProject.Api.Controllers;
using DResourceProject.Web;
...
namespace DResourceProject.Web
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            //ENABLE TO USE HANGFIRE dashboard (Requires enabling Hangfire in DResourceProjectWebModule)
